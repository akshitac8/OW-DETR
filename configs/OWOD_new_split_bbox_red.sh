...
EXP_DIR=exps/OWOD_t1_new_split_bbox_red
PY_ARGS=${@:1}
...
EXP_DIR=exps/OWOD_t2_new_split_bbox_red
PY_ARGS=${@:1}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t1_new_split_bbox_red/checkpoint0044.pth' \
    --rem_additional_bbox \
    ${PY_ARGS}

EXP_DIR=exps/OWOD_t2_ft_new_split_bbox_red
PY_ARGS=${@:1}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t2_new_split_bbox_red/checkpoint0049.pth' \
    --rem_additional_bbox \
    ${PY_ARGS}

EXP_DIR=exps/OWOD_t3_new_split_bbox_red
PY_ARGS=${@:1}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t2_ft_new_split_bbox_red/checkpoint0099.pth' \
    --rem_additional_bbox \
    ${PY_ARGS}

EXP_DIR=exps/OWOD_t3_ft_new_split_bbox_red
PY_ARGS=${@:1}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t3_new_split_bbox_red/checkpoint0104.pth' \
    --rem_additional_bbox \
    ${PY_ARGS}

EXP_DIR=exps/OWOD_t4_new_split_bbox_red
PY_ARGS=${@:1}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --rem_additional_bbox \
    --pretrain 'exps/OWOD_t3_ft_new_split_bbox_red/checkpoint0159.pth' \
    ${PY_ARGS}

EXP_DIR=exps/OWOD_t4_ft_new_split_bbox_red
PY_ARGS=${@:1}
...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t4_new_split_bbox_red/checkpoint0169.pth' \
    --rem_additional_bbox \
    ${PY_ARGS}